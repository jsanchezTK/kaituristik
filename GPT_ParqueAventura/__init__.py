...
# Datos Generales
comentarios = "Para consultas por reclamos y problemas, el contacto es experiencia@turistik.com. Para ventas corporativas y grupos grandes, contactar a Paula Ibarra: pibarra@turistik.com. Para consultas sobre colegios, visitas educativas contactar a Esteban García: egarcia@turistik.com y Daniela Jones: djones@turistik.com "
...
precios = "Ticket 2 Aventuras: $8.900 (consiste de 2 jugadas), Ticket 3 Aventuras: $11.900 (consiste de 3 jugadas) y Parque Full Aventura: $15.900 (consiste de 3 jugadas + Ticket Vive el Parque). Ticket Aventura Kids desde $6.000, según tiempo de juego. El ticket Vive el Parque es un ticket ilimitado por un día para Teleférico, Funicular y Buses Ecológicos.Tenemos Nuevos Tickets, los cuales son : Vive el parque full mini golf el cual incluye la entrada general a mini golf + viajes ilimitados en Teleférico, funicular y buses panorámicos, Full Pass el cual es un ticket de full diversión que te permite jugar de manera ilimitada en parque aventura outdoor,aventura kids y Mini Golf.Tambien incluye viajes ilimitados en Teleférico,Funicular y Buses Panoramicos. Aventura pass el cual podras jugar de manera ilimitada en Parque Aventura Outdoor,Aventura Kids y Mini Golf.Los tickets admiten un acompañante dentro de Parque Aventura que no puede hacer uso de los juegos, pero en el caso del Ticket Parque Full Aventura, el acompañante debe comprar su propio ticket para Teleférico, Funicular y Buses Ecológicos.Para más información, visitar el enlace: "+url+". "
...
horario_regular = "Desde el viernes 20 de junio hasta el domingo 6 de julio, todos los días (incluyendo lunes). Horario: 10:00 a 19:00 hrs, último ingreso a las 18:00. Funcionara con bloques de Horarios de 40 minutos " \
#"Parque Aventura abre Sábado, Domingo y festivos de 10:00 a 19:00 hrs, Siendo el ultimo ingreso a las 18:00 mientras que Aventura Kids está disponible de Martes a Domingo de 10:00 a 18:30 hrs,Siendo el ultimo Ingreso a las 18:30 hrs. Mini golf abre de Martes a Domingo de 10:00 a las 19:00 hrs. Siendo el ultimo ingreso a las 18:00 hrs. "
...
condiciones = "Por la seguridad de nuestros visitantes la estatura mínima en Parque Aventura es 1,45 m. y la estatura máxima 1,95 m, mientras que en Aventura Kids, la estatura mínima es de 1 m y la máxima es 1,50 m. al igual que el peso máximo para los juegos, el peso máximo es de 115kg. Mientras que en Mini golf no hay restricciones de estatura pero la edad sugerida es desde los 4 Años. En caso de encontrarse embarazada por seguridad del aventurero en camino no puede realizar las actividades, pero si ingresar como acompañante. Si eres menor de edad, debes venir siempre acompañado por un adulto responsable. La cantidad de adultos acompañantes es máximo 1 por jugador."\
...
"- Para consultas sobre colegios, visitas educativas contactar a Esteban García: egarcia@turistik.com y Daniela Jones: djones@turistik.com "
...
adicional += "\nDurante vacaciones de invierno el parque aventura outdoor funciona con bloques horarios cada 40 min, el horario seleccionado es el horario para entrar solo a parque aventura outdoor. En el caso de aventura kids y mini golf es por orden de llegada y disponibilidad presencial"
adicional += "\n todos lo cumpleaños incluyen tiempo de juego en mini golf, parque aventura outdoor o aventura kids, snack, regalo sorpresa, invitación digital, cumpleañero gratis. Las celebraciones de cumpleaños son tanto para niños como para adultos.Para más información sobre cumpleaños puedes revisar nuestros paquetes en www.turistik.com sección cumpleaños y/o contactar a nuestro ejecutivo a cargo María Laguna +56 964413723 correo: mlaguna@turistik.com"
